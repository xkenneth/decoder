...
from PyDrill.Decoders.InclinationDecoder import InclinationDecoder
...
try:
    ...
    while(1):
        ...
        while(1):
            ...
            if show_deltas:
                if last is not None:
                    print p.timeStamp - last.timeStamp, p.timeStamp
